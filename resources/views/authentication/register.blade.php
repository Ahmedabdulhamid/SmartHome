...
@section('title', __('web.sign_up'))

<head>
    {{-- ✅ تم تضمين سكريبت reCAPTCHA v3 في هذا الملف (انظر أعلاه) --}}
    ...
    <style>
        /*
        * --------------------------------
        * 1. GENERAL & LAYOUT (كود CSS كما هو)
        * --------------------------------
        */
        :root {
            ...
            <div class="row gy-4">
                <section id="contact" class="contact section">
                    <div class="col-lg-8 col-md-6 col-sm-12">
                        ...
                        <form class="php-email-form1" id="demo-form" method='POST' action="{{ route('register') }}">
                            @csrf
                            ...
                            <div class="row gy-4">
                                ...
                                <div class="form-group-custom">
                                    <input type="text" class="form-control" placeholder="{{ __('web.your_name') }}"
                                ...
                                {{-- حقل تأكيد كلمة المرور (مُضاف) --}}
                                <div class="form-group-custom">
                                    <input type="password" class="form-control"
                                        placeholder="{{ __('web.confirm_password') }}" name="password_confirmation">
                                </div>


                                {{-- ✅ زر الإرسال الرئيسي (تم إزالة خصائص reCAPTCHA منه) --}}
